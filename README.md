...
> 一款森系浪漫风格的跨平台音乐播放器 App，使用 Expo 54 + React Native 构建前端，Express.js 搭建后端服务，对接网易云音乐 API 获取真实音乐数据。内置 AI 音乐助手，支持自然语言对话式推荐歌单；多音源智能切换确保播放稳定性；花瓣形黑胶唱片旋转动画 + 实时滚动歌词带来沉浸式听歌体验。
